...
def sp_append(some_path: Strath | None) -> bool:
	"""
...
def sp_contains(some_path: Strath | None) -> bool:
	"""
...
def sp_prepend(some_path: Strath | None) -> bool:
	"""
...
def sp_remove(some_path: Strath | None) -> bool:
	"""
